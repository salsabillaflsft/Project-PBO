...
public class ViewHome extends JFrame{
    ...
    public ViewHome(){
        ...
        title2.setFont(new Font("Helvetica",Font.BOLD,50));
        title2.setForeground(blue);

        add(logo);
        logo.setBounds(50,180,626,444);
        add(logo2);
        logo2.setBounds(800,40,209,209);

        add(btnSee);
        btnSee.setBounds(800, 250, 250, 60);
        btnSee.setFont(font);
        btnSee.setBackground(blue);
        btnSee.setForeground(blue2);

        add(btnAdd);
        btnAdd.setBounds(800, 350, 250, 60);
        btnAdd.setFont(font);
        btnAdd.setBackground(blue);
        btnAdd.setForeground(blue2);

        add(btnEdit);
        btnEdit.setBounds(800, 450, 250, 60);
